// ignore_for_file: prefer_typing_uninitialized_variables, non_constant_identifier_names, use_build_context_synchronously, file_names, avoid_types_as_parameter_names
                                  ...
                                  itemBuilder: (BuildContext, int index){
                                    return InkWell(
                                        ...
                                        child: Container(
                                            margin: const EdgeInsets.only(right: 5),
                                            padding: const EdgeInsets.all(5),
                                            decoration: BoxDecoration(color:selectedIndex==list[index]?Color(0xffd9ac4f):Colors.grey,
