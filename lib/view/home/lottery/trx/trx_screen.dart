...
import 'package:wingrandseven/view/home/lottery/trx/trxWebBlock.dart';
import 'package:wingrandseven/view/home/lottery/trx/trxWebone.dart';
import 'package:flutter/foundation.dart';
import 'package:http/http.dart' as http;
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:wingrandseven/generated/assets.dart';
import 'package:wingrandseven/model/bettinghistoryTRX.dart';
...
import 'package:wingrandseven/view/home/lottery/trx/commonbottomsheetTRX.dart';
import 'package:wingrandseven/view/home/lottery/trx/dummygridTRX.dart';
...
class _TrxScreenState extends State<TrxScreen> with SingleTickerProviderStateMixin {
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    textWidget(
                                        ...
                                        color: selectedCatIndex == index ? Color(0xffb33e12) : Colors.grey,
                                        fontSize: 14),
                                    textWidget(
                      ...
                      Container(
                        ...
                        decoration:  BoxDecoration(
                            image: DecorationImage(
                                ...
                                // ),
                                image: AssetImage(Assets.imagesBgCut), fit: BoxFit.fill)),
                        child: Column(
                          children: [
                            Row(
          ...
          List.generate(
            _listdataResult.length,
              ...
              return Container(
                height: 30,
                width: width*0.97,
                decoration:  BoxDecoration(color: AppColors.primaryContColor),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: TextStyle(
            ...
            color: selectedTabIndex == index ? AppColors.primaryTextColor : Colors.grey,
          ),
        ),
      ),
    );
    ...
    Column(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              color: AppColors.primaryContColor, borderRadius: BorderRadius.circular(10)),
          child:  Text(
            time,
            style: const TextStyle(
                fontWeight: FontWeight.w800,
    ...
    children:[
      DefaultTextStyle(
        ...
        child: AnimatedTextKit(
            ...
            animatedTexts: [
              RotateAnimatedText('Welcome to ${AppConstants.appName}'),
              RotateAnimatedText('Welcome to ${AppConstants.appName}'),
              RotateAnimatedText('Welcome to ${AppConstants.appName}'),
              RotateAnimatedText('Welcome to ${AppConstants.appName}'),
              RotateAnimatedText('Welcome to ${AppConstants.appName}'),
