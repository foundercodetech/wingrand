...
import 'package:wingrandseven/view/home/lottery/WinGo/commonbottomsheet.dart';
...
import 'package:wingrandseven/view/home/lottery/WinGo/DummyGrid.dart';
import 'package:wingrandseven/view/home/lottery/WinGo/imagetoastWINGO.dart';
import 'package:wingrandseven/view/randomlist.dart';
          ...
          children: List.generate(
            _listdataResult.length,
              ...
              return Container(
                height: 30,
                width: width*0.97,
                decoration: const BoxDecoration(color: AppColors.primaryTextColor),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            gradient: selectedTabIndex == index
                ...
                : AppColors.containergreyGradient,
            borderRadius: BorderRadius.circular(8)),
        child: Text(
          label,
          style: TextStyle(
            ...
            color: selectedTabIndex == index ? AppColors.primaryTextColor : Colors.black,
          ),
        ),
      ),
    );
